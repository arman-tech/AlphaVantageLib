...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.WMA
{
    public class AvWMADefaultRepository : AvDefaultRepositoryAbs<AvWMA, AvWMAMetaData, AvWMABlock>
    {
        ...
        public AvWMADefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvWMA, bool>> CompareExpression(AvWMA rhs)
        {
            return ts =>
