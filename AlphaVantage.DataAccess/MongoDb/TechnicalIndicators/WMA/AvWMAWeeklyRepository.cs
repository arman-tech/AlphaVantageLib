...
{
    public class AvWMAWeeklyRepository : AvWeeklyRepositoryAbs<AvWMA, AvWMAMetaData, AvWMABlock>
    {
        ...
        public AvWMAWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
