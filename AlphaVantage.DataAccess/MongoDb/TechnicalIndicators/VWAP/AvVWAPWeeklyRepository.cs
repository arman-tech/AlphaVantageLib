...
{
    public class AvVWAPWeeklyRepository : AvWeeklyRepositoryAbs<AvVWAP, AvVWAPMetaData, AvVWAPBlock>
    {
        ...
        public AvVWAPWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
