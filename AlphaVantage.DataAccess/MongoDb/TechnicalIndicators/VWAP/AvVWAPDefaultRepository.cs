...
{
    public class AvVWAPDefaultRepository : AvDefaultRepositoryAbs<AvVWAP, AvVWAPMetaData, AvVWAPBlock>
    {
        ...
        public AvVWAPDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
