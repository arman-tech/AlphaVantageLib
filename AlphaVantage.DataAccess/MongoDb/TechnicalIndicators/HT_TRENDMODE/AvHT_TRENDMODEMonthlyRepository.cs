...
{
    public class AvHT_TRENDMODEMonthlyRepository : AvMonthlyRepositoryAbs<AvHT_TRENDMODE, AvHT_TRENDMODEMetaData, AvHT_TRENDMODEBlock>
    {
        ...
        public AvHT_TRENDMODEMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
