...
{
    public class AvHT_TRENDMODEDefaultRepository : AvDefaultRepositoryAbs<AvHT_TRENDMODE, AvHT_TRENDMODEMetaData, AvHT_TRENDMODEBlock>
    {
        ...
        public AvHT_TRENDMODEDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
