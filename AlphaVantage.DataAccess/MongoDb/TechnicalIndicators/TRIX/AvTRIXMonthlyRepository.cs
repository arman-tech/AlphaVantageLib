...
{
    public class AvTRIXMonthlyRepository : AvMonthlyRepositoryAbs<AvTRIX, AvTRIXMetaData, AvTRIXBlock>
    {
        ...
        public AvTRIXMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
