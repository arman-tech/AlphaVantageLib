...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.TRIX
{
    public class AvTRIXDefaultRepository : AvDefaultRepositoryAbs<AvTRIX, AvTRIXMetaData, AvTRIXBlock>
    {
        ...
        public AvTRIXDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvTRIX, bool>> CompareExpression(AvTRIX rhs)
        {
            return ts =>
