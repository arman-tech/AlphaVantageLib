...
{
    public class AvTRIXWeeklyRepository : AvWeeklyRepositoryAbs<AvTRIX, AvTRIXMetaData, AvTRIXBlock>
    {
        ...
        public AvTRIXWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
