...
{
    public class AvAPODefaultRepository : AvDefaultRepositoryAbs<AvAPO, AvAPOMetaData, AvAPOBlock>
    {
        ...
        public AvAPODefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
