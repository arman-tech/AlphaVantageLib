...
{
    public class AvAPOMonthlyRepository : AvMonthlyRepositoryAbs<AvAPO, AvAPOMetaData, AvAPOBlock>
    {
        ...
        public AvAPOMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
