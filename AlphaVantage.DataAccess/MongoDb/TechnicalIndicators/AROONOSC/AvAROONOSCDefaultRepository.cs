...
{
    public class AvAROONOSCDefaultRepository : AvDefaultRepositoryAbs<AvAROONOSC, AvAROONOSCMetaData, AvAROONOSCBlock>
    {
        ...
        public AvAROONOSCDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
