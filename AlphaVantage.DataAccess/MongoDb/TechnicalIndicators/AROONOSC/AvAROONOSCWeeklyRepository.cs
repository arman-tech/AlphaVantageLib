...
{
    public class AvAROONOSCWeeklyRepository : AvWeeklyRepositoryAbs<AvAROONOSC, AvAROONOSCMetaData, AvAROONOSCBlock>
    {
        ...
        public AvAROONOSCWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
