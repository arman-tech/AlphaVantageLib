...
{
    public class AvPLUS_DIDefaultRepository : AvDefaultRepositoryAbs<AvPLUS_DI, AvPLUS_DIMetaData, AvPLUS_DIBlock>
    {
        ...
        public AvPLUS_DIDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
