...
{
    public class AvPLUS_DIWeeklyRepository : AvWeeklyRepositoryAbs<AvPLUS_DI, AvPLUS_DIMetaData, AvPLUS_DIBlock>
    {
        ...
        public AvPLUS_DIWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
