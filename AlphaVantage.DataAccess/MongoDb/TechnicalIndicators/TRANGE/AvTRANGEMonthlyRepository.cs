...
{
    public class AvTRANGEMonthlyRepository : AvMonthlyRepositoryAbs<AvTRANGE, AvTRANGEMetaData, AvTRANGEBlock>
    {
        ...
        public AvTRANGEMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
