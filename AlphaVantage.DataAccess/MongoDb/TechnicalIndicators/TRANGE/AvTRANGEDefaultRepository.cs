...
{
    public class AvTRANGEDefaultRepository : AvDefaultRepositoryAbs<AvTRANGE, AvTRANGEMetaData, AvTRANGEBlock>
    {
        ...
        public AvTRANGEDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
