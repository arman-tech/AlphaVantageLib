...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.MIDPRICE
{
    public class AvMIDPRICEMonthlyRepository : AvMonthlyRepositoryAbs<AvMIDPRICE, AvMIDPRICEMetaData, AvMIDPRICEBlock>
    {
        ...
        public AvMIDPRICEMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvMIDPRICE, bool>> CompareExpression(AvMIDPRICE rhs)
        {
            return ts =>
