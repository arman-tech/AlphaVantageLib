...
{
    public class AvMIDPRICEWeeklyRepository : AvWeeklyRepositoryAbs<AvMIDPRICE, AvMIDPRICEMetaData, AvMIDPRICEBlock>
    {
        ...
        public AvMIDPRICEWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
