...
{
    public class AvCCIDefaultRepository : AvDefaultRepositoryAbs<AvCCI, AvCCIMetaData, AvCCIBlock>
    {
        ...
        public AvCCIDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
