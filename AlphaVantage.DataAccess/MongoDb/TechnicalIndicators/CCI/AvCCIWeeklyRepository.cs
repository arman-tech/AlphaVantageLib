...
{
    public class AvCCIWeeklyRepository : AvWeeklyRepositoryAbs<AvCCI, AvCCIMetaData, AvCCIBlock>
    {
        ...
        public AvCCIWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
