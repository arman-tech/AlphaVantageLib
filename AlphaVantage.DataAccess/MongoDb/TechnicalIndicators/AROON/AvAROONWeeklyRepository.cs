...
{
    public class AvAROONWeeklyRepository : AvWeeklyRepositoryAbs<AvAROON, AvAROONMetaData, AvAROONBlock>
    {
        ...
        public AvAROONWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
