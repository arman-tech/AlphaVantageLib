...
{
    public class AvAROONDefaultRepository : AvDefaultRepositoryAbs<AvAROON, AvAROONMetaData, AvAROONBlock>
    {
        ...
        public AvAROONDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
