...
{
    public class AvMINUS_DIMonthlyRepository : AvMonthlyRepositoryAbs<AvMINUS_DI, AvMINUS_DIMetaData, AvMINUS_DIBlock>
    {
        ...
        public AvMINUS_DIMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
