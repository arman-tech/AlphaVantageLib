...
{
    public class AvMINUS_DIDefaultRepository : AvDefaultRepositoryAbs<AvMINUS_DI, AvMINUS_DIMetaData, AvMINUS_DIBlock>
    {
        ...
        public AvMINUS_DIDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
