...
{
    public class AvHT_SINEWeeklyRepository : AvWeeklyRepositoryAbs<AvHT_SINE, AvHT_SINEMetaData, AvHT_SINEBlock>
    {
        ...
        public AvHT_SINEWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
