...
{
    public class AvHT_SINEMonthlyRepository : AvMonthlyRepositoryAbs<AvHT_SINE, AvHT_SINEMetaData, AvHT_SINEBlock>
    {
        ...
        public AvHT_SINEMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
