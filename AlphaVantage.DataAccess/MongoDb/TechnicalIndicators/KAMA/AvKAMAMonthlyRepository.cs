...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.KAMA
{
    public class AvKAMAMonthlyRepository : AvMonthlyRepositoryAbs<AvKAMA, AvKAMAMetaData, AvKAMABlock>
    {
        ...
        public AvKAMAMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvKAMA, bool>> CompareExpression(AvKAMA rhs)
        {
            return ts =>
