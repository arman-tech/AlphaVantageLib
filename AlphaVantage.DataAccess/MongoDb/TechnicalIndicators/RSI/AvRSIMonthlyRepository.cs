...
{
    public class AvRSIMonthlyRepository : AvMonthlyRepositoryAbs<AvRSI, AvRSIMetaData, AvRSIBlock>
    {

        public AvRSIMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                string dbName,
