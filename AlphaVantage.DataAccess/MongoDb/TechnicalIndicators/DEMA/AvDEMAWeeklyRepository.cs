...
{
    public class AvDEMAWeeklyRepository : AvWeeklyRepositoryAbs<AvDEMA, AvDEMAMetaData, AvDEMABlock>
    {
        ...
        public AvDEMAWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
