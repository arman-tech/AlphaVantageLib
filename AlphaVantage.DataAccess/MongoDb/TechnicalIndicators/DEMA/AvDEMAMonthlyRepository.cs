...
{
    public class AvDEMAMonthlyRepository : AvMonthlyRepositoryAbs<AvDEMA, AvDEMAMetaData, AvDEMABlock>
    {
        ...
        public AvDEMAMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
