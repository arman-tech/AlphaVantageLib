...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.DEMA
{
    public class AvDEMADefaultRepository : AvDefaultRepositoryAbs<AvDEMA, AvDEMAMetaData, AvDEMABlock>
    {
        ...
        public AvDEMADefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvDEMA, bool>> CompareExpression(AvDEMA rhs)
        {
            return ts =>
