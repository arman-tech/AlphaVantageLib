...
{
    public class AvATRDefaultRepository : AvDefaultRepositoryAbs<AvATR, AvATRMetaData, AvATRBlock>
    {
        ...
        public AvATRDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
