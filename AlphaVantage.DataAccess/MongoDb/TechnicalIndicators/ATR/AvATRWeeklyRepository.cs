...
{
    public class AvATRWeeklyRepository : AvWeeklyRepositoryAbs<AvATR, AvATRMetaData, AvATRBlock>
    {
        ...
        public AvATRWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
