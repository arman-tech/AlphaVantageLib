...
{
    public class AvTEMADefaultRepository : AvDefaultRepositoryAbs<AvTEMA, AvTEMAMetaData, AvTEMABlock>
    {
        public AvTEMADefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                string dbName,
