...
{
    public class AvSTOCHDefaultRepository : AvDefaultRepositoryAbs<AvSTOCH, AvSTOCHMetaData, AvSTOCHBlock>
    {
        ...
        public AvSTOCHDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
