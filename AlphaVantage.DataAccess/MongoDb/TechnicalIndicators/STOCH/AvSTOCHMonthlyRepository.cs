...
{
    public class AvSTOCHMonthlyRepository : AvMonthlyRepositoryAbs<AvSTOCH, AvSTOCHMetaData, AvSTOCHBlock>
    {
        ...
        public AvSTOCHMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
