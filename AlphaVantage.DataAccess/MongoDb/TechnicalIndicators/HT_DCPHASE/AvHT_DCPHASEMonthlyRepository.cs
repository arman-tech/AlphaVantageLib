...
{
    public class AvHT_DCPHASEMonthlyRepository : AvMonthlyRepositoryAbs<AvHT_DCPHASE, AvHT_DCPHASEMetaData, AvHT_DCPHASEBlock>
    {
        ...
        public AvHT_DCPHASEMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
