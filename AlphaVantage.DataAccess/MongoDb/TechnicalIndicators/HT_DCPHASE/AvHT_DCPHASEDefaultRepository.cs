...
{
    public class AvHT_DCPHASEDefaultRepository : AvDefaultRepositoryAbs<AvHT_DCPHASE, AvHT_DCPHASEMetaData, AvHT_DCPHASEBlock>
    {
        ...
        public AvHT_DCPHASEDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
