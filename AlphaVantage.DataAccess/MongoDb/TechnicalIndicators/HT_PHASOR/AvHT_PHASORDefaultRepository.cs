...
{
    public class AvHT_PHASORDefaultRepository : AvDefaultRepositoryAbs<AvHT_PHASOR, AvHT_PHASORMetaData, AvHT_PHASORBlock>
    {
        ...
        public AvHT_PHASORDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
