...
{
    public class AvHT_PHASORWeeklyRepository : AvWeeklyRepositoryAbs<AvHT_PHASOR, AvHT_PHASORMetaData, AvHT_PHASORBlock>
    {
        ...
        public AvHT_PHASORWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
