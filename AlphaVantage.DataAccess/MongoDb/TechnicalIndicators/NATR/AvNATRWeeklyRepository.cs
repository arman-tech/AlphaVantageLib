...
{
    public class AvNATRWeeklyRepository : AvWeeklyRepositoryAbs<AvNATR, AvNATRMetaData, AvNATRBlock>
    {
        ...
        public AvNATRWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
