...
{
    public class AvNATRMonthlyRepository : AvMonthlyRepositoryAbs<AvNATR, AvNATRMetaData, AvNATRBlock>
    {
        ...
        public AvNATRMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
