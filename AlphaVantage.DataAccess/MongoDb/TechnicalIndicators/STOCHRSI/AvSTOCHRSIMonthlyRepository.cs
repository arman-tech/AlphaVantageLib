...
{
    public class AvSTOCHRSIMonthlyRepository : AvMonthlyRepositoryAbs<AvSTOCHRSI, AvSTOCHRSIMetaData, AvSTOCHRSIBlock>
    {
        ...
        public AvSTOCHRSIMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
