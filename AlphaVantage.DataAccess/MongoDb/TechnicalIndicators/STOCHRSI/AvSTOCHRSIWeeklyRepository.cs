...
{
    public class AvSTOCHRSIWeeklyRepository : AvWeeklyRepositoryAbs<AvSTOCHRSI, AvSTOCHRSIMetaData, AvSTOCHRSIBlock>
    {
        ...
        public AvSTOCHRSIWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
