...
{
    public class AvROCMonthlyRepository : AvMonthlyRepositoryAbs<AvROC, AvROCMetaData, AvROCBlock>
    {
        ...
        public AvROCMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
