...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.ROC
{
    public class AvROCDefaultRepository : AvDefaultRepositoryAbs<AvROC, AvROCMetaData, AvROCBlock>
    {
        ...
        public AvROCDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvROC, bool>> CompareExpression(AvROC rhs)
        {
            return ts =>
