...
{
    public class AvROCWeeklyRepository : AvWeeklyRepositoryAbs<AvROC, AvROCMetaData, AvROCBlock>
    {
        ...
        public AvROCWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
