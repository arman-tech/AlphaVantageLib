...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.OBV
{
    public class AvOBVMonthlyRepository : AvMonthlyRepositoryAbs<AvOBV, AvOBVMetaData, AvOBVBlock>
    {
        ...
        public AvOBVMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvOBV, bool>> CompareExpression(AvOBV rhs)
        {
            return ts =>
