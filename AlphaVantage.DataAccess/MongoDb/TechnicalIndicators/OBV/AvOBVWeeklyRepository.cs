...
{
    public class AvOBVWeeklyRepository : AvWeeklyRepositoryAbs<AvOBV, AvOBVMetaData, AvOBVBlock>
    {
        ...
        public AvOBVWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
