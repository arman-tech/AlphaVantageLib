...
{
    public class AvOBVDefaultRepository : AvDefaultRepositoryAbs<AvOBV, AvOBVMetaData, AvOBVBlock>
    {
        ...
        public AvOBVDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
