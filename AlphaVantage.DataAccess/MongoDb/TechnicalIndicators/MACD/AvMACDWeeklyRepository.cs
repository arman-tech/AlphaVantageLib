...
{
    public class AvMACDWeeklyRepository : AvWeeklyRepositoryAbs<AvMACD, AvMACDMetaData, AvMACDBlock>
    {
        ...
        public AvMACDWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
