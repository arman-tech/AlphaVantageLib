...
{
    public class AvMACDDefaultRepository : AvDefaultRepositoryAbs<AvMACD, AvMACDMetaData, AvMACDBlock>
    {
        ...
        public AvMACDDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
