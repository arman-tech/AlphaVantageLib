...
{
    public class AvMAMAMonthlyRepository : AvMonthlyRepositoryAbs<AvMAMA, AvMAMAMetaData, AvMAMABlock>
    {

        public AvMAMAMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                string dbName,
