...
{
    public class AvCMOWeeklyRepository : AvWeeklyRepositoryAbs<AvCMO, AvCMOMetaData, AvCMOBlock>
    {
        ...
        public AvCMOWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
