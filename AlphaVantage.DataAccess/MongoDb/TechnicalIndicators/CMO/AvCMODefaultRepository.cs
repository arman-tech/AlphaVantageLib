...
{
    public class AvCMODefaultRepository : AvDefaultRepositoryAbs<AvCMO, AvCMOMetaData, AvCMOBlock>
    {
        ...
        public AvCMODefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
