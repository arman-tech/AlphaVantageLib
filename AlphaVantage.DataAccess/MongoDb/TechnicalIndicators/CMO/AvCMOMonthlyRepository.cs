...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.CMO
{
    public class AvCMOMonthlyRepository : AvMonthlyRepositoryAbs<AvCMO, AvCMOMetaData, AvCMOBlock>
    {
        ...
        public AvCMOMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvCMO, bool>> CompareExpression(AvCMO rhs)
        {
            return ts =>
