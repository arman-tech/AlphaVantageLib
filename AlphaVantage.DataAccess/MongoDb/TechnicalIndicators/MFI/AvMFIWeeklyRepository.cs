...
{
    public class AvMFIWeeklyRepository : AvWeeklyRepositoryAbs<AvMFI, AvMFIMetaData, AvMFIBlock>
    {
        ...
        public AvMFIWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
