...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.MFI
{
    public class AvMFIMonthlyRepository : AvMonthlyRepositoryAbs<AvMFI, AvMFIMetaData, AvMFIBlock>
    {
        ...
        public AvMFIMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvMFI, bool>> CompareExpression(AvMFI rhs)
        {
            return ts =>
