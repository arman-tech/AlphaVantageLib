...
{
    public class AvMFIDefaultRepository : AvDefaultRepositoryAbs<AvMFI, AvMFIMetaData, AvMFIBlock>
    {
        ...
        public AvMFIDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
