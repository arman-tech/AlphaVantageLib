...
{
    public class AvULTOSCDefaultRepository : AvDefaultRepositoryAbs<AvULTOSC, AvULTOSCMetaData, AvULTOSCBlock>
    {
        ...
        public AvULTOSCDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
