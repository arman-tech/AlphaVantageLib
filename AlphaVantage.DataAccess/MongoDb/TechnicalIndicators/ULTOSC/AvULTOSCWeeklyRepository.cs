...
{
    public class AvULTOSCWeeklyRepository : AvWeeklyRepositoryAbs<AvULTOSC, AvULTOSCMetaData, AvULTOSCBlock>
    {
        ...
        public AvULTOSCWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
