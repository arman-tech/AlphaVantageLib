...
{
    public class AvADXWeeklyRepository : AvWeeklyRepositoryAbs<AvADX, AvADXMetaData, AvADXBlock>
    {
        ...
        public AvADXWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
