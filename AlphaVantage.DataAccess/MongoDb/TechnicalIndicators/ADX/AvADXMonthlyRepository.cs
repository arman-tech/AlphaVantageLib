...
{
    public class AvADXMonthlyRepository : AvMonthlyRepositoryAbs<AvADX, AvADXMetaData, AvADXBlock>
    {
        ...
        public AvADXMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
