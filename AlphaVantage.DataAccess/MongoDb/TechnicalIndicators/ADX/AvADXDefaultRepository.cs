...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.ADX
{
    public class AvADXDefaultRepository : AvDefaultRepositoryAbs<AvADX, AvADXMetaData, AvADXBlock>
    {
        ...
        public AvADXDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvADX, bool>> CompareExpression(AvADX rhs)
        {
            return ts =>
