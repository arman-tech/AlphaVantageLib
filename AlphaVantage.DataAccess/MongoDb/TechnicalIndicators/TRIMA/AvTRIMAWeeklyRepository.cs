...
{
    public class AvTRIMAWeeklyRepository : AvWeeklyRepositoryAbs<AvTRIMA, AvTRIMAMetaData, AvTRIMABlock>
    {
        ...
        public AvTRIMAWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
