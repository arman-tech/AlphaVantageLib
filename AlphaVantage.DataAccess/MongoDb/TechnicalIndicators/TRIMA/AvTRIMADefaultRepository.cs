...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.TRIMA
{
    public class AvTRIMADefaultRepository : AvDefaultRepositoryAbs<AvTRIMA, AvTRIMAMetaData, AvTRIMABlock>
    {
        ...
        public AvTRIMADefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvTRIMA, bool>> CompareExpression(AvTRIMA rhs)
        {
            return ts =>
