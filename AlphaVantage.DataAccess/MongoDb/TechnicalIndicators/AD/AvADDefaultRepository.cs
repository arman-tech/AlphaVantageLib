...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.AD
{
    public class AvADDefaultRepository : AvDefaultRepositoryAbs<AvAD, AvADMetaData, AvADBlock>
    {
        ...
        public AvADDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvAD, bool>> CompareExpression(AvAD rhs)
        {
            return ts =>
