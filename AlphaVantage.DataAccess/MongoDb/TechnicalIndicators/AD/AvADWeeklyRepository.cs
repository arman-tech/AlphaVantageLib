...
{
    public class AvADWeeklyRepository : AvWeeklyRepositoryAbs<AvAD, AvADMetaData, AvADBlock>
    {
        ...
        public AvADWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
