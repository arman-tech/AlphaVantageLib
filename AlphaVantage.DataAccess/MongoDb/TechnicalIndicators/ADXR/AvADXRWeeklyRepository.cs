...
{
    public class AvADXRWeeklyRepository : AvWeeklyRepositoryAbs<AvADXR, AvADXRMetaData, AvADXRBlock>
    {
        ...
        public AvADXRWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
