...
{
    public class AvADXRDefaultRepository : AvDefaultRepositoryAbs<AvADXR, AvADXRMetaData, AvADXRBlock>
    {
        ...
        public AvADXRDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
