...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.WILLR
{
    public class AvWILLRDefaultRepository : AvDefaultRepositoryAbs<AvWILLR, AvWILLRMetaData, AvWILLRBlock>
    {
        ...
        public AvWILLRDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvWILLR, bool>> CompareExpression(AvWILLR rhs)
        {
            return ts =>
