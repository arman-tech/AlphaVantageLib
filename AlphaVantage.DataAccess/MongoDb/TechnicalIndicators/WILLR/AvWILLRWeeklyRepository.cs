...
{
    public class AvWILLRWeeklyRepository : AvWeeklyRepositoryAbs<AvWILLR, AvWILLRMetaData, AvWILLRBlock>
    {
        ...
        public AvWILLRWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
