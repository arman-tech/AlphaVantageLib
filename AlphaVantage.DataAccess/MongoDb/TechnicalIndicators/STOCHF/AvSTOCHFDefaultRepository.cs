...
{
    public class AvSTOCHFDefaultRepository : AvDefaultRepositoryAbs<AvSTOCHF, AvSTOCHFMetaData, AvSTOCHFBlock>
    {
        ...
        public AvSTOCHFDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
