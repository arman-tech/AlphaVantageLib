...
{
    public class AvSTOCHFMonthlyRepository : AvMonthlyRepositoryAbs<AvSTOCHF, AvSTOCHFMetaData, AvSTOCHFBlock>
    {
        ...
        public AvSTOCHFMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
