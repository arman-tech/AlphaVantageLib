...
{
    public class AvPLUS_DMDefaultRepository : AvDefaultRepositoryAbs<AvPLUS_DM, AvPLUS_DMMetaData, AvPLUS_DMBlock>
    {
        ...
        public AvPLUS_DMDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
