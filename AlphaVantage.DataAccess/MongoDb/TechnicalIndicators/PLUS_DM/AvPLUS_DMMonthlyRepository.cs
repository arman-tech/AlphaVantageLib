...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.PLUS_DM
{
    public class AvPLUS_DMMonthlyRepository : AvMonthlyRepositoryAbs<AvPLUS_DM, AvPLUS_DMMetaData, AvPLUS_DMBlock>
    {
        ...
        public AvPLUS_DMMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvPLUS_DM, bool>> CompareExpression(AvPLUS_DM rhs)
        {
            return ts =>
