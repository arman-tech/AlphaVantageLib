...
{
    public class AvMIDPOINTWeeklyRepository : AvDefaultRepositoryAbs<AvMIDPOINT, AvMIDPOINTMetaData, AvMIDPOINTBlock>
    {
        ...
        public AvMIDPOINTWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
