...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.MIDPOINT
{
    public class AvMIDPOINTMonthlyRepository : AvMonthlyRepositoryAbs<AvMIDPOINT, AvMIDPOINTMetaData, AvMIDPOINTBlock>
    {
        ...
        public AvMIDPOINTMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvMIDPOINT, bool>> CompareExpression(AvMIDPOINT rhs)
        {
            return ts =>
