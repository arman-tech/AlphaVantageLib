...
{
    public class AvMIDPOINTDefaultRepository : AvDefaultRepositoryAbs<AvMIDPOINT, AvMIDPOINTMetaData, AvMIDPOINTBlock>
    {
        ...
        public AvMIDPOINTDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
