...
{
    public class AvROCRMonthlyRepository : AvMonthlyRepositoryAbs<AvROCR, AvROCRMetaData, AvROCRBlock>
    {
        ...
        public AvROCRMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
