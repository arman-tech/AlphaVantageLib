...
{
    public class AvROCRDefaultRepository : AvDefaultRepositoryAbs<AvROCR, AvROCRMetaData, AvROCRBlock>
    {
        ...
        public AvROCRDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
