...
{
    public class AvMACDEXTDefaultRepository : AvDefaultRepositoryAbs<AvMACDEXT, AvMACDEXTMetaData, AvMACDEXTBlock>
    {
        ...
        public AvMACDEXTDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
