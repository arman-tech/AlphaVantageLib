...
{
    public class AvMACDEXTWeeklyRepository : AvWeeklyRepositoryAbs<AvMACDEXT, AvMACDEXTMetaData, AvMACDEXTBlock>
    {
        ...
        public AvMACDEXTWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
