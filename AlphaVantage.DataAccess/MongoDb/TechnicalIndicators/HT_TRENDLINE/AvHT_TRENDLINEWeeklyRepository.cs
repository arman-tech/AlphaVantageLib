...
{
    public class AvHT_TRENDLINEWeeklyRepository : AvWeeklyRepositoryAbs<AvHT_TRENDLINE, AvHT_TRENDLINEMetaData, AvHT_TRENDLINEBlock>
    {
        ...
        public AvHT_TRENDLINEWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
