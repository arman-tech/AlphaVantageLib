...
{
    public class AvHT_TRENDLINEDefaultRepository : AvDefaultRepositoryAbs<AvHT_TRENDLINE, AvHT_TRENDLINEMetaData, AvHT_TRENDLINEBlock>
    {
        ...
        public AvHT_TRENDLINEDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
