...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.EMA
{
    public class AvEMAMonthlyRepository : AvMonthlyRepositoryAbs<AvEMA, AvEMAMetaData, AvEMABlock>
    {
        ...
        public AvEMAMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvEMA, bool>> CompareExpression(AvEMA rhs)
        {
            return ts =>
