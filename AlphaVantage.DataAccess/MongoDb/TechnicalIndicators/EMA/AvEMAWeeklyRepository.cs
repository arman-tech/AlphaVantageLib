...
{
    public class AvEMAWeeklyRepository : AvWeeklyRepositoryAbs<AvEMA, AvEMAMetaData, AvEMABlock>
    {
        ...
        public AvEMAWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
