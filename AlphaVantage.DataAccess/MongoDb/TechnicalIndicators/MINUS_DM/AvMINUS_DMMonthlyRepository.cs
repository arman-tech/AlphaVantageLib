...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.MINUS_DM
{
    public class AvMINUS_DMMonthlyRepository : AvMonthlyRepositoryAbs<AvMINUS_DM, AvMINUS_DMMetaData, AvMINUS_DMBlock>
    {
        ...
        public AvMINUS_DMMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvMINUS_DM, bool>> CompareExpression(AvMINUS_DM rhs)
        {
            return ts =>
