...
{
    public class AvMINUS_DMDefaultRepository : AvDefaultRepositoryAbs<AvMINUS_DM, AvMINUS_DMMetaData, AvMINUS_DMBlock>
    {
        ...
        public AvMINUS_DMDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
