...
{
    public class AvT3WeeklyRepository : AvWeeklyRepositoryAbs<AvT3, AvT3MetaData, AvT3Block>
    {
        ...
        public AvT3WeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
