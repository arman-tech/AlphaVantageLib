...
{
    public class AvT3DefaultRepository : AvDefaultRepositoryAbs<AvT3, AvT3MetaData, AvT3Block>
    {
        ...
        public AvT3DefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
