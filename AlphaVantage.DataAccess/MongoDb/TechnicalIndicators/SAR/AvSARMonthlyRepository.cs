...
{
    public class AvSARMonthlyRepository : AvMonthlyRepositoryAbs<AvSAR, AvSARMetaData, AvSARBlock>
    {
        ...
        public AvSARMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
