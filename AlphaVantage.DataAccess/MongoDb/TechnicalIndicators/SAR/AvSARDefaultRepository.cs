...
{
    public class AvSARDefaultRepository : AvDefaultRepositoryAbs<AvSAR, AvSARMetaData, AvSARBlock>
    {
        ...
        public AvSARDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
