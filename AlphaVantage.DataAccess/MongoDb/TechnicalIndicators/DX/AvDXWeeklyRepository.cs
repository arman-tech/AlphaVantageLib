...
{
    public class AvDXWeeklyRepository : AvWeeklyRepositoryAbs<AvDX, AvDXMetaData, AvDXBlock>
    {
        ...
        public AvDXWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
