...
{
    public class AvDXDefaultRepository : AvDefaultRepositoryAbs<AvDX, AvDXMetaData, AvDXBlock>
    {
        ...
        public AvDXDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
