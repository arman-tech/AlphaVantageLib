...
{
    public class AvHT_DCPERIODWeeklyRepository : AvWeeklyRepositoryAbs<AvHT_DCPERIOD, AvHT_DCPERIODMetaData, AvHT_DCPERIODBlock>
    {
        ...
        public AvHT_DCPERIODWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
