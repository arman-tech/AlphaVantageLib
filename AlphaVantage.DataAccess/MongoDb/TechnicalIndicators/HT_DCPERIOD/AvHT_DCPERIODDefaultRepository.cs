...
{
    public class AvHT_DCPERIODDefaultRepository : AvDefaultRepositoryAbs<AvHT_DCPERIOD, AvHT_DCPERIODMetaData, AvHT_DCPERIODBlock>
    {
        ...
        public AvHT_DCPERIODDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
