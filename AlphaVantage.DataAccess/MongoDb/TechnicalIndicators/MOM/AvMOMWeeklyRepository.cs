...
{
    public class AvMOMWeeklyRepository : AvWeeklyRepositoryAbs<AvMOM, AvMOMMetaData, AvMOMBlock>
    {
        ...
        public AvMOMWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
