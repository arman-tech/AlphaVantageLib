...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.MOM
{
    public class AvMOMMonthlyRepository : AvMonthlyRepositoryAbs<AvMOM, AvMOMMetaData, AvMOMBlock>
    {
        ...
        public AvMOMMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvMOM, bool>> CompareExpression(AvMOM rhs)
        {
            return ts =>
