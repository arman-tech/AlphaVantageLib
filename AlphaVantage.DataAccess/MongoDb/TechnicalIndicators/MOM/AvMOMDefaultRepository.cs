...
{
    public class AvMOMDefaultRepository : AvDefaultRepositoryAbs<AvMOM, AvMOMMetaData, AvMOMBlock>
    {
        ...
        public AvMOMDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
