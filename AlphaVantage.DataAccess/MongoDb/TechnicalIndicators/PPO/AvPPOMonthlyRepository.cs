...
{
    public class AvPPOMonthlyRepository : AvMonthlyRepositoryAbs<AvPPO, AvPPOMetaData, AvPPOBlock>
    {
        ...
        public AvPPOMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
