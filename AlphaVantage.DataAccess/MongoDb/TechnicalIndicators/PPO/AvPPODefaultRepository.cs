...
{
    public class AvPPODefaultRepository : AvDefaultRepositoryAbs<AvPPO, AvPPOMetaData, AvPPOBlock>
    {
        ...
        public AvPPODefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
