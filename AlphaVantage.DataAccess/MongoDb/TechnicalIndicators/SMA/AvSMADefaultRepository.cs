...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.SMA
{
    public class AvSMADefaultRepository : AvDefaultRepositoryAbs<AvSMA, AvSMAMetaData, AvSMABlock>
    {
        ...
        public AvSMADefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvSMA, bool>> CompareExpression(AvSMA rhs)
        {
            return ts =>
