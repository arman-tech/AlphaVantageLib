...
{
    public class AvSMAWeeklyRepository : AvWeeklyRepositoryAbs<AvSMA, AvSMAMetaData, AvSMABlock>
    {
        ...
        public AvSMAWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
