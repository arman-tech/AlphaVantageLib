...
{
    public class AvADOSCMonthlyRepository : AvMonthlyRepositoryAbs<AvADOSC, AvADOSCMetaData, AvADOSCBlock>
    {
        ...
        public AvADOSCMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
