...
{
    public class AvADOSCDefaultRepository : AvDefaultRepositoryAbs<AvADOSC, AvADOSCMetaData, AvADOSCBlock>
    {
        ...
        public AvADOSCDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
