...
{
    public class AvBOPMonthlyRepository : AvMonthlyRepositoryAbs<AvBOP, AvBOPMetaData, AvBOPBlock>
    {
        ...
        public AvBOPMonthlyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
