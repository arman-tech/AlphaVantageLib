...
namespace AlphaVantage.DataAccess.MongoDb.TechnicalIndicators.BOP
{
    public class AvBOPDefaultRepository : AvDefaultRepositoryAbs<AvBOP, AvBOPMetaData, AvBOPBlock>
    {
        ...
        public AvBOPDefaultRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
        ...
        public override Expression<Func<AvBOP, bool>> CompareExpression(AvBOP rhs)
        {
            return ts =>
