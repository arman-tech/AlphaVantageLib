...
{
    public class AvBOPWeeklyRepository : AvWeeklyRepositoryAbs<AvBOP, AvBOPMetaData, AvBOPBlock>
    {
        ...
        public AvBOPWeeklyRepository(IContext<IMongoClient, IMongoDatabase> context,
                                         string dbName,
